...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Implements a simple rails reseed rake task'
  spec.description   = 'Implements a new rake task for rails applications that
                        will drop the database, create it, migrate and then
                        seed the clean database'
